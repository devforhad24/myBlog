            ...
            <div class="col-lg-8  mb-5 mb-lg-0">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('user_assets/images/post/post-10.jpg') }}" class="card-img-top"
                            alt="post-thumb">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('user_assets/images/post/post-3.jpg') }}" class="card-img-top"
                            alt="post-thumb">
                    </div>
                    <div class="card-body">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('user_asset/images/post/post-7.jpg') }}" class="card-img-top"
                            alt="post-thumb">
                    </div>
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('user_assets/images/post/post-8.jpg') }}" class="card-img-top"
                            alt="post-thumb">
                        <img src="{{ asset('user_assets/images/post/post-9.jpg') }}" class="card-img-top"
                            alt="post-thumb">
                    </div>
                    <div class="card-body">
                        <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes
