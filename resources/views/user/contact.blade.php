                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <form method="POST" action="{{ route('contact.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" class="form-control borderd" placeholder="Type your subject here..." required>
                        </div>
                        <div class="form-group">
                            <label for="message">Your Message Here</label>
                            <textarea name="message" id="message" class="summernote form-control" required></textarea>
                        </div>
